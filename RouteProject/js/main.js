  ...
  if (container[i].classList.contains("signinPage")) {
    ...
    function userExist() {
      ...
      for (let i = 0; i < usersArray.length; i++) {
        ...
        if (
          usernamesigninInput.value == storedUser.email &&
          passwordsigninInput.value == storedUser.password
        ) {
...
// let name = localStorage.getItem("email") ? localStorage.getItem("email") : "";
// console.log(email);
// if (email == "") {
...
addEntry();
function addEntry() {
  var entryTitle = document.getElementById("names").value;
  var entryText = document.getElementById("caseType").value;
  var entryText = document.getElementById("age").value;
  var entryText = document.getElementById("diseases").value;
  var entryText = document.getElementById("case-descr").value;

  var entry = {
    nameInput: names,
    texcasetypeInput: caseType,
    age: age,
    diseases: diseases,
    casedescr: casedescr,
  };
...
function save() {
  alert("Ur data has been saved ty");
}
